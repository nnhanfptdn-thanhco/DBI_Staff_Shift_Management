...
\title{\textbf{BÁO CÁO BÀI TẬP LỚN RBL - CƠ SỞ DỮ LIỆU (DBI202)}\\
\large Hệ thống Quản lý Ca làm việc và Chấm công (Staff Shift Management)}
\author{Nhóm Sinh Viên: Nhóm 01}
\date{\today}
...
\begin{abstract}
Báo cáo này tổng hợp tiến độ nghiên cứu và triển khai đề tài học tập theo định hướng nghiên cứu (RBL) môn Cơ sở dữ liệu (DBI202) từ Tuần 5 đến Tuần 7. Nội dung bao gồm việc xác định câu hỏi nghiên cứu, thiết kế mô hình thực thể - liên kết (ERD), xây dựng lược đồ quan hệ trên SQL Server và phát triển mã nguồn JavaScript (Node.js) để làm sạch, xử lý dữ liệu chấm công thực tế.
\end{abstract}

\tableofcontents
\newpage

\section{Tuần 5: Chọn đề tài \& Xác định vai trò của Database}

\subsection{Tên đề tài nghiên cứu}
\textbf{Hệ thống Quản lý Ca làm việc và Chấm công nhân viên (Staff Shift Management)}

\subsection{Lý do chọn đề tài}
Trong thực tế, các cửa hàng bán lẻ, chuỗi F\&B hay doanh nghiệp vừa và nhỏ sử dụng rất nhiều nhân viên làm việc theo ca. Việc chấm công thủ công bằng sổ tay hoặc Excel rất dễ gây ra nhầm lẫn giờ làm, tính sai tiền lương thù lao, đặc biệt là với những ca làm đêm vắt sang ngày hôm sau.

Vì vậy, nhóm chọn đề tài này nhằm mục đích thiết kế một cơ sở dữ liệu quan hệ chặt chẽ giúp tự động hóa việc lưu trữ lịch làm việc, ghi nhận thẻ chấm công hằng ngày và hỗ trợ tính toán thù lao một cách chính xác.

\subsection{Xác định các thực thể và mối quan hệ}
Mô hình dữ liệu của hệ thống gồm 3 thực thể chính:
\begin{itemize}
    \item \textbf{STAFF (Nhân viên):} Quản lý thông tin mã nhân viên (\texttt{UserID}), họ tên, vai trò và mức lương thù lao theo giờ (\texttt{HourlyRate}).
...
\section{Tuần 6: Công cụ \& Quy trình triển khai Dataset}
...
\section{Tuần 7: Thu thập dữ liệu thực tế \& Xử lý ban đầu}
